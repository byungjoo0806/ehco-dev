    ...
    return (
        <div className="min-h-screen bg-white dark:bg-slate-800">
            <div className="max-w-3xl mx-auto px-4 py-8">
                <h1 className="text-3xl font-bold text-center mb-8 dark:text-key-color">Privacy Policy</h1>

                <p className="text-gray-600 mb-8 dark:text-gray-400">Last Updated: May 4, 2025</p>
                ...
                <div className="prose max-w-none">
                    ...
                    <ul className="list-disc ml-6 mb-6 dark:text-gray-300">
                        <li><span className="font-bold dark:text-gray-100">Newsletter Subscription:</span>
                        ...
                        <li><span className="font-bold dark:text-gray-100">Contacting Us:</span> If you contact us directly (e.g., via email or a contact form),
                        ...
                        <li><span className="font-bold dark:text-gray-100">Website Usage Information:</span> Like most websites,
                        ...
                        <li><span className="font-bold dark:text-gray-100">Information We Do Not Collect:</span> We do not require registration
                    ...
                    <p className="mb-4 dark:text-gray-300">We use the information we collect for the following purposes:</p>
                    <ul className="list-disc ml-6 mb-6 dark:text-gray-300">
                    ...
                    <p className="mb-4 dark:text-gray-300">We may share information in the following limited circumstances:</p>
                    <ul className="list-disc ml-6 mb-6 dark:text-gray-300">
                        <li><span className="font-bold dark:text-gray-100">Service Providers:</span> We may share information with third-party vendors
                        ...
                        <li><span className="font-bold dark:text-gray-100">Legal Requirements:</span> We may disclose information if required to do so by law
                    ...
                    <ul className="list-disc ml-6 mb-6 dark:text-gray-300">
                        <li><span className="font-bold dark:text-gray-100">Newsletter:</span> You can unsubscribe from our newsletter at any time by
                            clicking the &ldquo;unsubscribe&rdquo; link provided in the emails.
                        </li>
                        <li><span className="font-bold dark:text-gray-100">Contact Information:</span> If you have provided us with your email address for the newsletter
                        ...
                        <li><span className="font-bold dark:text-gray-100">Cookies:</span> You can manage cookie preferences through your browser settings.</li>
                    </ul>
                    ...
                    <p className="mb-2 dark:text-gray-300">If you have any questions or concerns about this Privacy Policy or our privacy practices, please contact us at:</p>
                    <p className="mb-6 dark:text-gray-300">Email: <span className="underline">info@ehco.com</span>
                    </p>
