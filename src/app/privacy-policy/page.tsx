    ...
    return (
        <div className="max-w-3xl mx-auto px-4 py-8">
            ...
            <div className="prose max-w-none">
                ...
                <h2 className="text-xl font-bold text-pink-500 mt-8 mb-4">1. Information We Collect</h2>
                <p className="mb-4">
                ...
                <h2 className="text-xl font-bold text-pink-500 mt-8 mb-4">2. How We Use Your Information</h2>
                ...
                <h2 className="text-xl font-bold text-pink-500 mt-8 mb-4">3. Cookies and Similar Technologies</h2>
                <p className="mb-6">
                ...
                <h2 className="text-xl font-bold text-pink-500 mt-8 mb-4">4. Data Sharing and Disclosure</h2>
                <p className="mb-4">
                ...
                <h2 className="text-xl font-bold text-pink-500 mt-8 mb-4">5. Data Security</h2>
                <p className="mb-6">
                ...
                <h2 className="text-xl font-bold text-pink-500 mt-8 mb-4">6. Your Choices and Rights</h2>
                <ul className="list-disc ml-6 mb-6">
                ...
                <h2 className="text-xl font-bold text-pink-500 mt-8 mb-4">7. Changes to This Privacy Policy</h2>
                <p className="mb-6">
                ...
                <h2 className="text-xl font-bold text-pink-500 mt-8 mb-4">8. Contact Us</h2>
