    ...
    return (
        <div className="min-h-screen bg-white dark:bg-slate-800">
            <div className="max-w-3xl mx-auto px-4 py-8">
                <h1 className="text-3xl font-bold text-center mb-8 dark:text-key-color">Terms of Service</h1>
                ...
                <div className="prose max-w-none">
                    ...
                    <p className="mb-4 dark:text-gray-300"> <span className="font-bold dark:text-gray-100">Permitted Use:</span>
                    ...
                    <p className="mb-4 dark:text-gray-300"><span className="font-bold dark:text-gray-100">Prohibited Use:</span> You agree not to:</p>
                    ...
                    <p className="mb-4 dark:text-gray-300"><span className="font-bold dark:text-gray-100">Third-Party Content:</span>
                    ...
                    <p className="mb-4 dark:text-gray-300"><span className="font-bold dark:text-gray-100">EHCO Content:</span>
                    ...
                    <p className="mb-6 dark:text-gray-300"><span className="font-bold dark:text-gray-100">Copyright and Attribution Policy:</span>
                    ...
                    <p className="text-center text-gray-500 mt-12 dark:text-gray-300">© EHCO 2025</p>
                </div>
            </div>
        </div>
    );
