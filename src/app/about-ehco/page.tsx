    ...
    return (
        <div className="min-h-screen bg-white dark:bg-slate-800">
            <main className="max-w-4xl mx-auto px-4 py-16">
                <h1 className="text-4xl font-bold text-center mb-12 dark:text-key-color">About Us</h1>
                ...
                <section className="mb-16">
                    ...
                    <ul className="list-disc pl-6 space-y-3 text-gray-700 dark:text-gray-300">
                        <li>
                            <strong className='dark:text-gray-100'>Credible Sources</strong>: Information starts from established, trusted sources.
                        </li>
                        <li>
                            <strong className='dark:text-gray-100'>Structured Journeys</strong>: Organizing data chronologically into comprehensive event histories
                        </li>
                        <li>
                            <strong className='dark:text-gray-100'>Source Link</strong>: Every event links directly to its original source for transparency.
                        </li>
                        <li>
                            <strong className='dark:text-gray-100'>Accuracy Focus</strong>: Automation is paired with human review to ensure relevance and factual
                            grounding.
                        </li>
                    </ul>
                </section>
